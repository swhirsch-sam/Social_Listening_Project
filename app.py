...
def render_results(brand_name, results):
    ...
    sources = ['Threads', 'LinkedIn', 'Twitter/X', 'Reddit']
    ...
    platform_names = ['Threads', 'LinkedIn', 'Twitter/X', 'Reddit']
...
st.caption('Brand Sentiment Intelligence')
st.markdown(
    'Enter a brand name to scrape Threads, LinkedIn, Twitter/X, and Reddit '
